...
$sql="select * from docente"; // creamos la sentencia sql
...
{
  $datos[$i]=array($col['nombre_doc' ], $col['apellido_doc' ], $col['ci_doc' ], $col['fecha_doc' ], $col['telefono' ], $col['email' ]); //se guardan los datos en un arreglo
    $i++;
}
...
$TEMPLATE_TOSHOW = 'perfil/contactos_1.tpl';

...
//    header("Location: login.php");
  ...
  $smarty->assign('mascara'     ,'perfilpro/listas.mascara.tpl');
  $smarty->assign('lista'       ,'perfilpro/usuario.lista.tpl');
...
if (isset($_GET['tlista']) && $_GET['tlista']) //recargamos la tabla central
  $smarty->display('perfilpro/listas.lista.tpl'); 
else
  $smarty->display('perfilpro/full-width.tpl');

      <div id="content">
        <h1 class="title">Registro de Estudiantes usando un archivo CVS</h1>
        <p>Formulario de registro de estudiantes</p>
        <h2 class="title">Formulario de Registro</h2>
        <div id="respond">
          <form action="#" method="post" id="registro" name="registro" >
            <p>
              <textarea name="cvs" rows="4" cols="60" style="width: 431px;height: 305px;" data-validation-engine="validate[required]"></textarea>

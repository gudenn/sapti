...
<div class="wrapper row3">
  <div class="rnd">
    <div id="container" class="clear">
        ...
        <div class="clear"></div>
    <center> <td bgcolor="#F7F7F7" style="text-align:center"><strong>LISTA DE PERFILES POSTERGADOS</strong></td></center>
...
<div >
  ...
  {/section}
   ...
   <tr bgcolor="#F1F5F8">
   <center> <td bgcolor="#F7F7F7" style="text-align:center">
   <em><strong><a href="postergadoexcel.php" class="botonlink">excel</a></strong></em>
   <em><strong><a href="postergados-pdf.php" class="botonlink">PDF</a></strong></em></td></center>
    </tr>

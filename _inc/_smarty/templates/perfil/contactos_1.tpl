...
<table width="85%" border="1"  align="center" cellpadding="5" cellspacing="5" bordercolor="#999999" class="Estilo2">
   <tr bgcolor="#F1F5F8">
      <td bgcolor="#F7F7F7" style="text-align:center"><strong>LISTA DE PERFILES POSTERGADOS</strong></td>
    </tr>
    ...
    <tr bgcolor="#F1F5F8">
        ...
        <table width="100%" cellpadding="2" cellspacing="2" bordercolor="#999999" border="1">
				...
				<td width="7%" class="label" style="text-align:center"><strong>eliminar</strong></td>

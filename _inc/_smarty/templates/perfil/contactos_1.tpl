...
<table width="85%" border="1"  align="center" cellpadding="5" cellspacing="5" bordercolor="#999999" class="Estilo2">
   <tr bgcolor="#F1F5F8">
      <td bgcolor="#F7F7F7" style="text-align:center"><strong>LISTA DE DOCENTES</strong></td>
    </tr>
    ...
    <td width="2%" class="label" style="text-align:center"><strong>N?</strong></td>
                <td width="2%" class="label" style="text-align:center"><strong>NOMBRES</strong></td>
	  		  	<td width="17%" class="label" style="text-align:center"><strong>APELlIDOS</strong></td>
               ...
               <td width="7%" class="label" style="text-align:center"><strong>EMAIL</strong></td>
  ...
  <tr bgcolor="#F1F5F8">
    <td bgcolor="#F7F7F7" style="text-align:center"><em><strong><a href="registroD.php" class="botonlink">REGISTRAR DOCENTE</a></strong></em></td>
    </tr>
</table>
</div>
</div>

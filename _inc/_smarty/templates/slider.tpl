...
<div class="wrapper">
  <div id="featured_slide" class="clear">
    ...
    <div id="featured_content">
      ...
      <div class="featured_box" id="fc2"><img src="{$URL_IMG}academic/slider/2.gif" alt="" />
        <div class="floater">
      ...
      <div class="featured_box" id="fc3"><img src="{$URL_IMG}academic/slider/3.gif" alt="" />
        <div class="floater">
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
      ...
      <div class="featured_box" id="fc4"><img src="{$URL_IMG}academic/slider/4.gif" alt="" />
        <div class="floater">
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
      ...
      <div class="featured_box" id="fc5"><img src="{$URL_IMG}academic/slider/5.gif" alt="" />
        <div class="floater">

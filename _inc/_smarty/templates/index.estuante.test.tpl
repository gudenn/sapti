    ...
    <div id="container" class="clear">
      ...
      <div id="homepage" class="clear">
        ...
        <div id="left_column">
          ...
          <div class="imgholder"><a href="#"><img src="{$URL_IMG}/academic/220x80.gif" alt="" /></a></div>
        ...
        <div id="latestnews">
          ...
          <ul>
            <li class="clear">
              <div class="imgl"><img src="{$URL_IMG}/academic/imgl.gif" alt="" /></div>
              <div class="latestnews">
                <p><a href="#">Sentumquisque morbi dui congue.</a></p>
                <p>Estudiante</p>
                <p>{$estudiante->nombre}</p>
                <p>{$estudiante->apellido_paterno}</p>
                <p>{$estudiante->apellido_materno}</p>
                <p>{$estudiante->codigo_sis}</p>
                <p></p>
              </div>
            </li>
            <li class="clear">
        ...
        <div id="right_column">
          <div class="holder">
            <h2>Virtual Tour</h2>
            <a href="#"><img src="{$URL_IMG}/academic/video.gif" alt="" /></a> </div>
          <div class="holder">
            <h2>Quick Information</h2>
            <div class="apply"><a href="#"><img src="{$URL_IMG}/academic/100x100.gif" alt="" /> <strong>Make An Application</strong></a></div>
            <div class="apply"><a href="#"><img src="{$URL_IMG}/academic/100x100.gif" alt="" /> <strong>Order A Prospectus</strong></a></div>
          </div>
        </div>
        <!-- ###### -->
      </div>

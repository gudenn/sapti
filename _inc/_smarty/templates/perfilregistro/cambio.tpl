...
<!-- ####################################################################################################### -->   
 ...
 <table width="78%" height="911" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
      {section name=ic loop=$perfilregistro} 
    <td colspan="3" valign="top" nowrap="nowrap"><p align="center"><strong>Ap.Paterno</strong>:
        <input name="appaterno" value="{$perfilregistro[ic]['titulo']}" type="text" size="20" /></p></td>
   
    <td colspan="4" valign="top" nowrap="nowrap"><p align="center"><strong>Ap.Materno</strong>:
      <input name="apmaterno" value="{$usuario->apellidos}" type="text" size="20" />
    </p></td>
    <td colspan="2" valign="top"><p align="center"><strong> Nombres</strong>: 
      <input name="nombre" value="{$usuario->nombre}" type="text" size="20" />
    </p></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="4" valign="top"><p align="left"><strong>Tipo de Cambio</strong>:
       <label>
        <select name=cambio_id>
          <option>-----Seleccione-----</option>
          <option>Cambio Leve</option>
          <option>Cambio Tema</option>
      </select>
    </p>     
    </td>
  </tr>
  <tr>
    <td colspan="10" valign="top"><p><strong>Titulo</strong>:
        <textarea name="titulo" cols="115" rows="1.5" >{$perfilregistro[ic]['titulo']}</textarea>
      </p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="75" colspan="10" valign="middle"><p><strong>Objetivo General</strong>:</p>
      <p align="center">
        <textarea name="objetivogeneral" cols="105" rows="2">{$perfilregistro[ic]['objetivogeneral']}</textarea>
    </p></td>
  </tr>
  <tr>
    <td height="203" colspan="10" valign="top"><p><strong>Objetivos Espec&iacute;ficos</strong>:</p>
      <p align="center">
         <textarea name="objetivoespecifico" cols="105" rows="10">{$perfilregistro[ic]['objetivoespecifico']}</textarea>
    </p>      </td>
  </tr>
  <tr>
